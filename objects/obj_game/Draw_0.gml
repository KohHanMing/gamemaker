...
helpTextWidth = string_width("Help");
helpTextHeight = string_height("Help");
draw_set_alpha(helpTextSmallAlpha)
draw_text_transformed(room_width/2, room_height/2 + 200, string("Help") + "", 0.8, 0.8, 0);
draw_set_alpha(helpTextLargeAlpha)
draw_text_transformed(room_width/2, room_height/2 + 200, string("Help") + "", 1, 1, 0);
